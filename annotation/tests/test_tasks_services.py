...
from annotation.tasks.services import check_cross_annotating_pages, validate_files_info, validate_task_info, validate_users_info
...
def test_check_cross_annotating_pages_negative_case(db_session: Session):
    ...
    expected_error_message = "within cross validation job user can't validate file's pages that are already distributed in annotation tasks for this user: {4, 5}"
