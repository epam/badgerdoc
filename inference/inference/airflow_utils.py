...
from inference.config import (
    ...
    AIRFLOW_SERVICE_PATH_PREFIX,
    AIRFLOW_SERVICE_PORT,
    AIRFLOW_SERVICE_SCHEME,
    AIRFLOW_USERNAME,
)

AIRFLOW_URL = f"{AIRFLOW_SERVICE_SCHEME}://{AIRFLOW_SERVICE_HOST}"
if AIRFLOW_SERVICE_PORT:
    AIRFLOW_URL = f"{AIRFLOW_URL}:{AIRFLOW_SERVICE_PORT}"

AIRFLOW_URL = f"{AIRFLOW_URL}{AIRFLOW_SERVICE_PATH_PREFIX}"
