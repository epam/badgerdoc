    ...
    yield [
        {
            ...
            "config": {
                ...
                "singleSignOnServiceUrl": "https://access-staging.epam.com/auth/realms/plusx/protocol/saml",  # noqa
