...
from src.converters.labelstudio.annotation_converter import AnnotationConverter
from src.converters.labelstudio.models.annotation import (
    LabelStudioModel,
    ValidationType,
)
...
class LabelstudioToBadgerdocConverter:
    ...
    def execute(self) -> None:
        ...
        ls_converter = ConverterToBadgerdoc()
