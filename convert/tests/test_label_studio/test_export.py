...
from src.label_studio_to_badgerdoc.labelstudio_format.label_studio_format import LabelStudioFormat
from src.label_studio_to_badgerdoc.badgerdoc_format import annotation_converter_practic
from src.label_studio_to_badgerdoc.models import bd_annotation_model_practic, bd_manifest_model_practic
...
def test_annotation_converter():
    ...
    labelstudio_format_test.from_badgerdoc(
        badgerdoc_annotations=annotations_test, badgerdoc_tokens=tokens_test, badgerdoc_manifest=manifest_test
    )
    ...
    assert (
        set(str(relation) for relation in labelstudio_model_etalon.__root__[0].meta.relations) ==
        set(str(relation) for relation in labelstudio_model_test.__root__[0].meta.relations)
    )
