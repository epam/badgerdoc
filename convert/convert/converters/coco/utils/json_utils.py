...
def merge_jobs_annotation(
    ...
    Find the last id of the object(annotation, image, category) and
    continue to extend list from the next id.
    If image_id or category_id has been changed, then check bboxes this job
    and change this field to right.
    Args:
