...
from src.schema import AnnotationData, MatchedPage, Page, ParagraphBbox
from src.third_party_code.box_util import stitch_boxes_into_lines
from src.third_party_code.table import BorderBox
