...
import { AGENT_TAB_ID, WorkspaceTabs } from './components/workspace-tabs'
...
import { useExtractionState } from '@/features/workspace/hooks/extraction-state'
import { useExtractionApi } from '@/features/workspace/hooks/extraction-api'
import { useReloadDraftAutosave } from '@/features/workspace/hooks/use-reload-draft-autosave'
import { useExtractionChatContext } from '@/features/workspace/hooks/extraction-chat-context'
...
import { WorkspaceLoadingSkeleton } from '@/features/workspace/components/workspace-loading-skeleton'
import {
  TaskFiltersSearch,
  taskFiltersFromSearch,
  taskFiltersToSearch,
} from '@/helpers/task-filters-search'
import { ExtractionResultsTab } from '@/features/workspace/components/extraction-results-tab'
import { DocumentOverviewPopover } from '@/features/workspace/components/document-overview'
import { NoExtractionTagsEmptyState } from '@/features/workspace/components/no-extraction-tags-empty-state'
import { AgentLogsTab } from '@/features/workspace/components/agent-logs'
