...
import { AppMenuItem } from 'shared/contexts/app-menu';
...
export const isPathAllowed = (menu: AppMenuItem[], path: Path | readonly Path[] | undefined) => {
    ...
    const foundIndex = menu.findIndex((item) => {
        ...
        return item.children?.findIndex((innerItem) => innerItem === currentMenuItem) !== -1;
    });
    return foundIndex !== -1;
};
